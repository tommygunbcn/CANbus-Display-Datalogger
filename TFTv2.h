...
#define FONT_SPACE 6				// size of font in font.c
#define FONT_X 8
#define FONT_Y 8

//extern uint8_t SmallFont1[][12];
...
#else
#define TFT_CS_LOW  {DDRD |= 0x20;PORTD &=~ 0x20;}   // D5
#define TFT_CS_HIGH {DDRD |= 0x20;PORTD |=  0x20;}
#define TFT_DC_LOW  {DDRD |= 0x40;PORTD &=~ 0x40;}	 //D6
#define TFT_DC_HIGH {DDRD |= 0x40;PORTD |=  0x40;}
#define TFT_BL_OFF  {DDRD |= 0x80;PORTD &=~ 0x80;}	 //D7
...
public:
	...
	void TFTinit (void);
	INT16U getDisplayXSize(void);
	INT16U getDisplayYSize(void);
	...
	void drawChar(INT8U ascii,INT16U poX, INT16U poY,INT16U size, INT16U fgcolor, INT16U back_fgcolor);
    void drawString(char *string, INT16U stl, INT16U poX, INT16U poY,INT16U size,INT16U fgcolor, INT16U back_fgcolor);
	void drawString(const char *string, INT16U stl, INT16U poX, INT16U poY, INT16U size, INT16U fgcolor, INT16U back_fgcolor);
   /* {
        drawString((char*)string, stl, poX, poY, size, fgcolor, back_fgcolor);
    }*/
	void drawString(String string, INT16U poX, INT16U poY, INT16U size, INT16U fgcolor, INT16U back_fgcolor);
	void drawString(String* string, INT16U poX, INT16U poY, INT16U size, INT16U fgcolor, INT16U back_fgcolor);
    ...
    INT8U drawNumber(long long_num,INT16U poX, INT16U poY,INT16U size,INT16U fgcolor, INT16U back_fgcolor);
    INT8U drawFloat(float floatNumber,INT8U decimal,INT16U poX, INT16U poY,INT16U size,INT16U fgcolor, INT16U back_fgcolor);
    INT8U drawFloat(float floatNumber,INT16U poX, INT16U poY,INT16U size,INT16U fgcolor, INT16U back_fgcolor);
